...
<div class="container-fluid" style="overflow:hidden">
            <div class="row" style="margin-left: 0px; margin-right: 10px">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 " style=" heigth=504px ;padding-left: 0px; padding-right: 10px">
                    <div id="carouselExampleInterval" class="carousel slide carousel-fade" data-ride="carousel" style="width:fit-content;height: 504px; margin-left: 10px; margin-top: 50px ;margin-right:50px">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-interval="3000">
                                <img src="z1.jpg" class="d-block w-100" id="imagesize" style="height: 504px">
                            </div>
                            <div class="carousel-item">
                                <img src="z2.jpg" class="d-block w-100" alt="..." id="imagesize" style="height: 504px">
                            </div>
                            <div class="carousel-item">
                                <img src="z3.jpg" class="d-block w-100" alt="..." id="imagesize" style="height: 504px">
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 " style="height: 504px; padding-left: 10px; padding-right: 0px; margin-left: -30px;">
                    <div style="margin-top: 50px; margin-left: 10px">
                        <h1 style="color: #EC4D37; text-align: center;font-family: monospace;">Zaitoon</h1>
			...
			try {
				...
				ps = conn.prepareStatement("select * from hotels where Name='Zaitoon'");
				rs = ps.executeQuery();
				while (rs.next()) {
		%>
                                ...
                                <iframe style="padding-left: 20px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15551.915250533166!2d80.2194214!3d12.9732069!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x96f19c37ad93b07c!2sZaitoon%20Restaurant!5e0!3m2!1sen!2sin!4v1604243977006!5m2!1sen!2sin"
	...
	<div style="padding-left: 15px; padding-right: 15px; overflow:hidden;" >
        ...
        <%
			...
			try {
				...
				ps1 = conn1.prepareStatement("select * from hotels where Name='Zaitoon'");
        ...
        <a style="color: red;" href="https://www.zomato.com/chennai/zaitoon-velachery" target="_blank">ZOMATO</a>
        <a style="color: rgb(250, 154, 29);" href="https://www.swiggy.com/restaurants/zaitoon-velachery-chennai-35172" target="_blank">SWIGGY</a>
        <a style="color: white;" href="https://www.dineout.co.in/chennai/zaitoon-velachery-south-west-chennai-15429" target="_blank">DINEOUT</a>
			...
			<div class="row mt-3" >
				<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4"
					...
					<hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto"
						style="width: 60px;">
					<a href="https://www.instagram.com/zaitoonofficial/" target="_blank"><img src="insta.jpg" width="50" height="50" title="insta" alt="insta"></a>
					<a href="https://www.facebook.com/ZaitoonRestaurant/" target="_blank"><img src="fb.jpg" width="50" height="50" title="fb" alt="fb"></a>
					<a href="https://twitter.com/hellozaitoon?lang=en" target="_blank"><img src="twitter.jpg" width="50" height="50" title="twitter" alt="twitter"></a>
